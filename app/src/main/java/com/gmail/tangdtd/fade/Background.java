...
//            "varying vec4 v_Color;" +
    ...
    private final int bgStrideBytes = 3*4;
...
//    private final int bgColorDataSize = 4;
    ...
    /*private final float [] testBGVerticesData = {
            -c0, c1, 0f,
            0f, 0f, 1f, 1f,
            c0, c1, 0f,
            0f, 0f, 1f, 1f,
...
//        bgColorHandle = GLES20.glGetAttribLocation(programHandle, "a_Color");
        bgColorHandle = GLES20.glGetUniformLocation(programHandle, "v_Color");
    }
